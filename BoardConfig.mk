DEVICE_TREE := device/samsung/heroqlte
...
TARGET_KERNEL_DEVICE_DEFCONFIG := device_heroqlte_tmo
...
BOARD_MKBOOTIMG_ARGS := --kernel_offset 0x00008000 --ramdisk_offset 0x02200000 --tags_offset 0x02000000 --board SRPPA14A001RU
...
TARGET_INIT_VENDOR_LIB := libinit_heroqlte
TARGET_RECOVERY_DEVICE_MODULES := libinit_heroqlte
TARGET_LIBINIT_DEFINES_FILE := $(DEVICE_TREE)/init/init_heroqlte.cpp
